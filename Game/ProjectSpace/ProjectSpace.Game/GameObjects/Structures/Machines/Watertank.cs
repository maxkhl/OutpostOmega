...
namespace OutpostOmega.Game.GameObjects.Structures.Machines
{
    ...
    public class Watertank : Machine
    {
            ...
            : base(X, Y, Z, Structure, World, ID)
        {
            ...
            var model = LoadModel(@"Content\Model\Structure\Machinery\watertank.dae");
            model.AssignTexture("Cube", this, LoadTexture(@"Content\Model\Structure\Machinery\watertank.png"));
