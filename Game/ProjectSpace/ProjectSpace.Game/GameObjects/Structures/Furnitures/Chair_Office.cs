...
namespace OutpostOmega.Game.GameObjects.Structures
{
    ...
    public class Chair_Office : Structure
    {
            ...
            : base(X, Y, Z, Structure, World, ID)
        {
            ...
            var model = LoadModel(@"Content\Model\Structure\Furniture\chair_office.dae");
            model.AssignTexture("Cylinder", this, LoadTexture(@"Content\Model\Structure\Furniture\chair_office.png"));
