    ...
    public class DrawStuffOtk : GameWindow
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            try
            {
                ...
                stmChecker = a.GetManifestResourceStream("OutpostOmega.Server.Drawer.Textures.checkered.png");
                stmGround = a.GetManifestResourceStream("OutpostOmega.Server.Drawer.Textures.ground.png");
                stmSky = a.GetManifestResourceStream("OutpostOmega.Server.Drawer.Textures.sky.png");
                stmWood = a.GetManifestResourceStream("OutpostOmega.Server.Drawer.Textures.wood.png");
                stmGrass = a.GetManifestResourceStream("OutpostOmega.Server.Drawer.Textures.grass.jpeg");
            }
            catch
            {
        ...
        public void dsDrawLine(JVector _pos1, JVector _pos2)
        {
        ...
        public void dsDrawTriangle(JVector pos, JMatrix R, float[] vAll, int v0, int v1,
                                       int v2, bool solid)
        {
            if (current_state != 2)
                Console.WriteLine("drawing function called outside simulation loop");
