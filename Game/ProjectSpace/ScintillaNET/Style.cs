...
namespace ScintillaNET
{
    ...
    public class Style
    {
        ...
        public static class Lua
        {
            ...
            /// Default style index.
            /// </summary>
            public const int Keywords = NativeMethods.SCE_L_KEYWORDS;

            /// <summary>
            /// Comment style index.
            /// </summary>
            public const int BasicFunctions = NativeMethods.SCE_L_BASIC;

            /// <summary>
            /// Keyword (set 0) style index.
            /// </summary>
            public const int Functions = NativeMethods.SCE_L_FUNC;

            /// <summary>
            /// Base keyword (set 1) style index.
            /// </summary>
            public const int coroutines = NativeMethods.SCE_L_COROUT;

            /// <summary>
            /// Other keyword (set 2) style index.
            /// </summary>
            public const int user1 = NativeMethods.SCE_L_USR1;

            /// <summary>
            /// Number style index.
            /// </summary>
            public const int user2 = NativeMethods.SCE_L_USR2;

            /// <summary>
            /// Double-quoted string style index.
            /// </summary>
            public const int user3 = NativeMethods.SCE_L_USR3;

            /// <summary>
            /// Single-quoted string style index.
            /// </summary>
            public const int user4 = NativeMethods.SCE_L_USR4;
        }
