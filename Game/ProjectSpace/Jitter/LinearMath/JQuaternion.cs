...
namespace Jitter.LinearMath
{
    ...
    public struct JQuaternion
    {
        ...
        public static JQuaternion Dot(JQuaternion q1, JQuaternion q2)
        {
        ...
        public static JQuaternion Diff(JQuaternion q1, JQuaternion q2)
        {
            return q2 * JQuaternion.Conjugate(q1);
        }
        ...
        public static JQuaternion operator /(JQuaternion q1, float v2)
        {
            return new JQuaternion
            {
                X = q1.X / v2,
