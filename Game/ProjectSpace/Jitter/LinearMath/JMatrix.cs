...
namespace Jitter.LinearMath
{
    ...
    public struct JMatrix
    {
        ...
        public static JMatrix CreateScale(JVector Factor)
        {
            JMatrix matrix;
            matrix.M11 = Factor.X;
            matrix.M12 = 0f;
        ...
        public static bool Compare(JMatrix matrix1, JMatrix matrix2)
        {
        ...
        public static JVector ViewMatrixLeft(JMatrix viewMatrix)
        {
        ...
        public static JVector ViewMatrixRight(JMatrix viewMatrix)
        {
            return new JVector(viewMatrix.M11, viewMatrix.M21, viewMatrix.M31);
        }

        public static JVector ViewMatrixUp(JMatrix viewMatrix)
        {
            return new JVector(viewMatrix.M12, viewMatrix.M22, viewMatrix.M33);
        }

        public static JVector ViewMatrixDown(JMatrix viewMatrix)
        {
        ...
        public static JVector ViewMatrixForward(JMatrix viewMatrix)
        {
        ...
        public static JVector ViewMatrixBackward(JMatrix viewMatrix)
        {
            return new JVector(viewMatrix.M13, viewMatrix.M23, viewMatrix.M33);
        }


        public static JMatrix CreateTranslation(JVector vector)
        {
            JMatrix Result = JMatrix.Identity;
            Result.M31 = vector.X;
            Result.M32 = vector.Y;
            Result.M33 = vector.Z;
            return Result;            
