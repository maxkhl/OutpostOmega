...
namespace Jitter.LinearMath
{
    ...
    public struct JVector
    {
        ...
        /// A vector with components (-1,-1,-1);
        /// </summary>
        public static readonly JVector mOne;
        /// <summary>
        ...
        public JVector Round(int decimals)
        {
            return new JVector((float)Math.Round(X, decimals), (float)Math.Round(Y, decimals), (float)Math.Round(Z, decimals));
        }
        ...
        public static JVector TranslationFromMatrix(JMatrix Matrix)
        {
            return new JVector(Matrix.M13, Matrix.M23, Matrix.M33);
        }

        public static JVector Divide(JVector vector1, float value)
        {
            return new JVector(vector1.X / value, vector1.Y / value, vector1.Z / value);
        }
        ...
        public static JVector Multiply(JVector value1, JVector value2)
        {
            return new JVector(value1.X * value2.X, value1.Y * value2.Y, value1.Z * value2.Z);
        }
        ...
        #endregion
        public static JVector Scale(float f, JVector a)
        {
            return new JVector(f * a.X, f * a.Y, f * a.Z);
        }
        public static JVector Projection(JVector a, JVector b)
        {
            return Scale(Dot(a, b) / Dot(b, b), b);
        }
        public static JVector Rejection(JVector a, JVector b)
        {
