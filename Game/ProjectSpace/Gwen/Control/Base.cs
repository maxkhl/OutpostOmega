...
namespace Gwen.Control
{
    ...
    public class Base : IDisposable
    {
        ...
        /// <summary>
        /// Check for opened windows inside of this base
        /// </summary>
        public bool CheckWindowOpen(Type WindowType, bool BringToFront = true)
        {
            var hit = (from child in Children
                            where
                                WindowType.IsAssignableFrom(child.GetType())
