	...
	public partial class GameObject : IDisposable
    {
        ...
        public GameObject Parent
        {
            ...
            set
            {
                if (_Parent != value)
                {
                    if (value.RigidBody != null && this.RigidBody != null)
        ...
        public GameObject(World World, string ID = "GameObject")
		{
            ...
            this.ID = ID + World.IDCounter[ID];
            //this.ID = ID + World.AllGameObjects.Count; //Assign ID
        ...
        /// </summary>
        public virtual GameObjects.Function[] FunctionRequest(GameObjects.Mobs.Mind Requester)
        {
