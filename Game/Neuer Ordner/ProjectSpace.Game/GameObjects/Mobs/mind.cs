...
{
    /// <summary>
    /// A mind that contains a player
    /// </summary>
    public class Mind : GameObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Prevents this mind from commanding a mob
        /// </summary>
        ...
        {
            if (Mob != null && !Lock && World.ClientMode)
            {
                ...
                Mob.View.AddRotation(((float)(mouseState.X - OldMouseState.X)) * (float)ElapsedTime, (float)(mouseState.Y - OldMouseState.Y) * (float)ElapsedTime);
